...
#CA_02 Verify the function changing the number of data show in each list
...
#
#CA_03 Verify the function of navigating the list of data page
#    [Tags]      MainPage      UI     Smoketest
#    Go to "Customer Account" page
#    Then Check the amount of page list
#         ${Last_name}=      Get data in the last row
#    When Create another test data with "Farmer Side" type
...
#    [Tags]      MainPage      UI
#    Create a test data with "Farmer Side" type
...
#    When Click on the "Xóa" button in the "_@Họ và tên@_" table line
#
#CA_06_01 Check data information after creation (Farmer Side)
#    [Tags]        DetailedInfo      UI        Smoketest
...
#    When Click on the "Xóa" button in the "_@Họ và tên@_" table line
#
#CA_06_02 Check data information after creation (Order Side)
#    [Tags]        DetailedInfo        UI        Smoketest
#    ${today}=     Get Current Date      local     result_format=%d/%m/%Y
#    Create a test data with "Order Side" type
#    When Click on the "Chi tiết" button in the "_@Họ và tên@_" table line
#    Then Data's information in "Họ và tên" should be equal "_@Họ và tên@_"
#    Then Data's information in "Email" should be equal "_@Email@_"
#    Then Data's information in "Giới tính" should be equal "_@Giới tính@_"
...
#    When Click on the "Xóa" button in the "_@Họ và tên@_" table line
#
#CA_11 Check the update of data list after cancel the search action
#    [Tags]        Search
#    ${AccountName}=                                                                               Create a test data with "Farmer Side" type
#    Create another test data with "Order Side" type
...
#
#CA_22 Create new customer data with the valid data
#    [Tags]          Create          Smoketest
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
...
#    When Click "Đóng lại" button
#
#CA_24 Check the update of data list after creating a new data
#    [Tags]          Create        Smoketest
#    Go to "Customer Account" page
#    When Create another test data with "Farmer Side" type
#    Then "_@Họ và tên@_" should be visible in table line
...
#CA_25 Create a new data with all blank fields
...
#
#CA_26 Create a new data when leaving "Họ và tên" field blank
#    [Tags]        Create        BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "email" in "Email" with "_RANDOM_"
#    When Enter "phone" in "Số điện thoại" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng nhập họ và tên" displayed under "Họ và tên" field
#
#CA_27 Create a new data when leaving "Email" field blank
#    [Tags]        Create        BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "phone" in "Số điện thoại" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng nhập email" displayed under "Email" field
#
#CA_28 Create a new data when leaving "Số điện thoại" field blank
#    [Tags]          Create          BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng nhập số điện thoại" displayed under "Số điện thoại" field
#
#CA_29 Create a new data when leaving "Giới tính" field blank
#    [Tags]          Create          BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng chọn giới tính" displayed under "Giới tính" field
#
#CA_30 Create a new data when leaving "Loại tài khoản" field blank
#    [Tags]          Create          BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng chọn loại tài khoản" displayed under "Loại tài khoản" field
#
#CA_31 Create a new data when leaving "Mật khẩu" field blank
#    [Tags]          Create          BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#    Then Required message "Xin vui lòng nhập mật khẩu" displayed under "Mật khẩu" field
#
#CA_32 Create a new acdatacount when leaving "Xác nhận mật khẩu" field blank
#    [Tags]          Create          BlankField
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#CA_33 Create a new data with the invalid email
#    [Tags]          Create          Invalid
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
#
#CA_35 Create a new data with the existed phone number
#    [Tags]        Create        Invalid
#    ${AccountName}=     Create a test data with "Farmer Side" type
#    When Click "Tạo mới" button
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
#
#CA_36 Create a new data with the existed email
#    [Tags]          Create          Invalid
#    ${AccountName}=       Create a test data with "Farmer Side" type
#    When Click "Tạo mới" button
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
#    Then Click on the "Xóa" button in the "${AccountName}" table line
#
#CA_37 Create a new data with the "Xác nhận mật khẩu" different with "Mật khẩu"
#    [Tags]      Create        Invalid
#    Go to page create data "Tài khoản Người dùng" with "/customer-account"
#    When Enter "test name" in "Họ và tên" with "_RANDOM_"
#    When Enter "email" in "Email" with "_RANDOM_"
...
#    Then "_@Họ và tên@_" should not be visible in table line
#
#CA_50 Verify the cancel action button when delete data
#    [Tags]        Delete
#    Create a test data with "Farmer Side" type
...
Create a test data with "${type}" type
    When Go to page create data "Tài khoản Người dùng" with "/customer-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
