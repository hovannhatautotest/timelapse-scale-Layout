...
IA_02 Verify the function changing the number of data show in each list
...
IA_03 Verify the function navigating to other lists of data page
    [Tags]                                                                                        MainPage                                     UI                                          Smoketest
    Go to "Internal Account" page
    Then Check the amount of page list
         ${Last_name}=                                                                            Get data in the last row
    When Create another test data with "CSKH" type
...
IA_04 Verify the highlight table line function after operated
    [Tags]                                                                                        MainPage                                     UI
    Create a test data with "Kế toán" type
...
IA_05 Verify that navigating to the right "Detail-information" page
    ...
    Create a test data with "CSKH" type
...
IA_06_01 Check data information after creation (CSKH)
    [Tags]                                                                                        DetailedInfo                                 UI                                           Smoketest
...
IA_06_02 Check data information after creation (Kế toán)
    [Tags]                                                                                        DetailedInfo                                 UI                                           Smoketest
    ${today}=                                                                                     Get Current Date                             local                             result_format=%d/%m/%Y
    Create a test data with "Kế toán" type
    When Click on the "Chi tiết" button in the "_@Họ và tên@_" table line
...
#    Then Account's information in "Ngày hoạt động cuối" should be equal "${today}"
    When Click "Trở lại" button
    When Click on the "Xóa" button in the "_@Họ và tên@_" table line
### Verify the lock data function ###
IA_07 Verify the block data funtion
    [Tags]                                                                                        Lock                        BUG1                 Smoketest
    Create a test data with "Kế toán" type
    When Click on the "Chi tiết" button in the "_@Họ và tên@_" table line
...
IA_08 Verify the unblock data function
    [Tags]                                                                                        Lock                         BUG1                Smoketest
    Create a test data with "Kế toán" type
    When Click on the "Chi tiết" button in the "_@Họ và tên@_" table line
    When Click "Khóa" button
...
IA_11 Check the update of data list after cancel the search action
    [Tags]                                                                                        Search
    ${AccountName}=                                                                               Create a test data with "CSKH" type
    Create another test data with "Kế toán" type
...
IA_20 Create new data with the valid data
    [Tags]                                                                                        Create                                       Smoketest
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
...
IA_22 Check the update of data list after creating a new data
    [Tags]                                                                                        Create                                       Smoketest
    Go to "Internal Account" page
    When Create another test data with "Kế toán" type
    Then "_@Họ và tên@_" should be visible in table line
    Then Click on the "Xóa" button in the "_@Họ và tên@_" table line

### Create new data with blank field ###
IA_23 Create a new data with all blank fields
...
IA_24 Create a new data when leaving "Họ và tên" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "email" in "Email" with "_RANDOM_"
    When Enter "phone" in "Số điện thoại" with "_RANDOM_"
...
IA_25 Create a new data when leaving "Email" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "phone" in "Số điện thoại" with "_RANDOM_"
...
IA_26 Create a new data when leaving "Số điện thoại" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_27 Create a new data when leaving "Giới tính" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_28 Create a new data when leaving "Loại tài khoản" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_29 Create a new data when leaving "Mật khẩu" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_30 Create a new data when leaving "Xác nhận mật khẩu" field blank
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_31 Create a new data with the invalid email
    [Tags]                                                                                        Create                                       BlankField
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
IA_33 Create a new data with the existed phone number
    [Tags]                                                                                        Create                                       Invalid
    ${AccountName}=                                                                               Create a test data with "Kế toán" type
    When Click "Tạo mới" button
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_34 Create a new data with the existed email
    [Tags]                                                                                        Create                                       Invalid
    ${AccountName}=                                                                               Create a test data with "Kế toán" type
    When Click "Tạo mới" button
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
IA_35 Create a new data with the "Xác nhận mật khẩu" different with "Mật khẩu"
    [Tags]                                                                                        Create                                       Invalid
    Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
    When Enter "email" in "Email" with "_RANDOM_"
...
IA_47 Verify the delete data function
...
IA_48 Verify the cancel action button when delete data
    [Tags]                                                                                        Delete
    Create a test data with "Kế toán" type
...
Create a test data with "${type}" type
    When Go to page create data "Tài khoản Nội bộ" with "/internal-account"
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
...
Create another test data with "${type}" type
    When Click "Tạo mới" button
    When Enter "test name" in "Họ và tên" with "_RANDOM_"
         ${text}=               Check Text             _@Họ và tên@_
