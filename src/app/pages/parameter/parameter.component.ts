...
import { EStatusParameters, GlobalFacade, Parameter, ParametersFacade } from '@store';
...
export class ParameterComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.parametersFacade.status$.subscribe((value) => {
      switch (value) {
        case EStatusParameters.postOk:
        case EStatusParameters.putOk:
        case EStatusParameters.deleteOk:
          this.parametersFacade.getAll();
          break;
      }
    });
