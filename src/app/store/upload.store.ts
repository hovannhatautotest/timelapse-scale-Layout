...
type entityType = 'data' | 'post' | 'clinic' | 'farmer' | 'wallet';
...
export enum EStatusUpload {
  idle = 'idle',
  getAttachmentTemplates = 'getAttachmentTemplates',
  getAttachmentTemplatesOk = 'getAttachmentTemplatesOk',
  error = 'error',
}
...
export const uploadReducer = createReducer(
  ...
  on(_actions.getAttachmentTemplates, (_state, data) => ({
    ..._state,
    isLoading: true,
    status: EStatusUpload.getAttachmentTemplates,
  ...
  on(_actions.getAttachmentTemplatesOk, (_state, data) => ({
    ...
    ...data,
    isLoading: false,
    status: EStatusUpload.getAttachmentTemplatesOk,
  })),

  on(_actions.error, (_state) => ({ ..._state, isLoading: false, status: EStatusUpload.error })),
);
