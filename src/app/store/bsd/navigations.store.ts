...
export enum EStatusNavigation {
  ...
  getTree = 'getTree',
  getTreeOk = 'getTreeOk',
  getUserWebapp = 'getUserWebapp',
  getUserWebappOk = 'getUserWebappOk',
  post = 'post',
  postOk = 'postOk',
  put = 'put',
  putOk = 'putOk',
...
const initialState: NavigationState = {
  ...
  data: undefined,
  isLoading: false,
  status: EStatusNavigation.idle,
};

export const navigationReducer = createReducer(
  initialState,

  on(_actions.post, (_state) => ({ ..._state, isLoading: true, status: EStatusNavigation.post })),
  on(_actions.postOk, (_state, data) => ({ ..._state, ...data, isLoading: false, status: EStatusNavigation.postOk })),

  on(_actions.put, (_state) => ({ ..._state, isLoading: true, status: EStatusNavigation.put })),
  on(_actions.putOk, (_state, data) => ({ ..._state, ...data, isLoading: false, status: EStatusNavigation.putOk })),

  on(_actions.delete, (_state) => ({ ..._state, isLoading: true, status: EStatusNavigation.delete })),
  on(_actions.deleteOk, (_state, data) => ({
    ..._state,
    ...data,
    isLoading: false,
    status: EStatusNavigation.deleteOk,
  })),

  on(_actions.getTree, (_state) => ({ ..._state, isLoading: true, status: EStatusNavigation.getTree })),
  on(_actions.getTreeOk, (_state, data) => ({
    ..._state,
    ...data,
    isLoading: false,
    status: EStatusNavigation.getTreeOk,
  })),

  on(_actions.getUserWebapp, (_state) => ({ ..._state, isLoading: true, status: EStatusNavigation.getUserWebapp })),
  on(_actions.getUserWebappOk, (_state, data) => ({
    ..._state,
    ...data,
    isLoading: false,
    status: EStatusNavigation.getUserWebappOk,
  })),

  on(_actions.error, (_state) => ({ ..._state, isLoading: false, status: EStatusNavigation.error })),
);
